...
class Foundation(unittest.TestCase):
    ...
    def test_schema_rejects_incomplete_training_and_test_access(self):
        ...
        other=run_record('test','training',m,p,[],manifest_path=ROOT/'research/new_campaign/dataset_manifest.json')
        self.assertEqual(other['data']['manifest'],'research/new_campaign/dataset_manifest.json')
