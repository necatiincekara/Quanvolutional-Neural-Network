...
> Current evidence favors classical baselines overall: `resnet18_cifar_gray = 88.13 ± 0.82` test, `thesis_cnniiii = 85.26 ± 0.97`, and `classical_conv = 81.40 ± 1.06`; April 2026 V7 reruns remain engineering case-study evidence spanning `65.88--72.53%` test.
